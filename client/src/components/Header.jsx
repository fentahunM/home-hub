...
//         <Link to="/">
//           <h1 className="font-bold md:text-3xl flex flex-wrap text-blue-600 transition-colors hover:opacity-85">
//             HomeHub
//           </h1>
//         </Link>
//         <form
...
//           </button>
//         </form>
//         <ul className="flex gap-4 text-xl text-blue-600 items-center ">
//           <Link to="/">
//             <li className="hidden sm:inline p-2 rounded-md  hover:text-green-700 ">
//               Home
//             </li>
//           </Link>
//           <a href="#about">
